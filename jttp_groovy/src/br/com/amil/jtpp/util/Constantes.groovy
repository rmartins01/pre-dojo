...
final class Constantes {
	...
	static final NEW_MATCH = "New match";
	static final HAS_STARTED = "has started";
	static final MATCH = "Match";
	static final HAS_ENDED = "has ended";
	static final KILLED = "killed";
	static final USING = "using";
	...
	static final NOME_ARQUIVO_LOG_JTPP = "JTPP.log"

	static final DELIMITADOR_ARQUIVO_LOG_JTPP = " "
}